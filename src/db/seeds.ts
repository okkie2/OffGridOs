...
const VICTRON_MPPT: Array<{
  ...
  { mppt_type_id: 'victron-75-10',   model: 'SmartSolar 75/10',   tracker_count: 1, max_voc: 75,  max_charge_current: 10,  nominal_battery_voltage: 48, max_pv_power: 10  * 48 },
  { mppt_type_id: 'victron-75-15',   model: 'SmartSolar 75/15',   tracker_count: 1, max_voc: 75,  max_charge_current: 15,  nominal_battery_voltage: 48, max_pv_power: 15  * 48 },
  { mppt_type_id: 'victron-100-15',  model: 'SmartSolar 100/15',  tracker_count: 1, max_voc: 100, max_charge_current: 15,  nominal_battery_voltage: 48, max_pv_power: 15  * 48 },
  { mppt_type_id: 'victron-100-20',  model: 'SmartSolar 100/20',  tracker_count: 1, max_voc: 100, max_charge_current: 20,  nominal_battery_voltage: 48, max_pv_power: 20  * 48 },
  { mppt_type_id: 'victron-150-35',  model: 'SmartSolar 150/35',  tracker_count: 1, max_voc: 150, max_charge_current: 35,  nominal_battery_voltage: 48, max_pv_power: 35  * 48 },
  { mppt_type_id: 'victron-150-45',  model: 'SmartSolar 150/45',  tracker_count: 1, max_voc: 150, max_charge_current: 45,  nominal_battery_voltage: 48, max_pv_power: 45  * 48 },
  { mppt_type_id: 'victron-150-60',  model: 'SmartSolar 150/60',  tracker_count: 1, max_voc: 150, max_charge_current: 60,  nominal_battery_voltage: 48, max_pv_power: 60  * 48 },
  { mppt_type_id: 'victron-150-70',  model: 'SmartSolar 150/70',  tracker_count: 1, max_voc: 150, max_charge_current: 70,  nominal_battery_voltage: 48, max_pv_power: 70  * 48 },
  { mppt_type_id: 'victron-150-85',  model: 'SmartSolar 150/85',  tracker_count: 1, max_voc: 150, max_charge_current: 85,  nominal_battery_voltage: 48, max_pv_power: 85  * 48 },
  { mppt_type_id: 'victron-150-100', model: 'SmartSolar 150/100', tracker_count: 1, max_voc: 150, max_charge_current: 100, nominal_battery_voltage: 48, max_pv_power: 100 * 48 },
  { mppt_type_id: 'victron-250-60',  model: 'SmartSolar 250/60',  tracker_count: 1, max_voc: 250, max_charge_current: 60,  nominal_battery_voltage: 48, max_pv_power: 60  * 48 },
  { mppt_type_id: 'victron-250-70',  model: 'SmartSolar 250/70',  tracker_count: 1, max_voc: 250, max_charge_current: 70,  nominal_battery_voltage: 48, max_pv_power: 70  * 48 },
  { mppt_type_id: 'victron-250-85',  model: 'SmartSolar 250/85',  tracker_count: 1, max_voc: 250, max_charge_current: 85,  nominal_battery_voltage: 48, max_pv_power: 85  * 48 },
  { mppt_type_id: 'victron-250-100', model: 'SmartSolar 250/100', tracker_count: 1, max_voc: 250, max_charge_current: 100, nominal_battery_voltage: 48, max_pv_power: 100 * 48 },
  {
...
export function seedMpptTypes(db: Database.Database): void {
  const insert = db.prepare(`
    INSERT OR IGNORE INTO mppt_types
      (mppt_type_id, model, tracker_count, max_voc, max_pv_power, max_pv_input_current_a, max_pv_short_circuit_current_a, max_charge_current, nominal_battery_voltage, notes)
    VALUES
      (@mppt_type_id, @model, @tracker_count, @max_voc, @max_pv_power, @max_pv_input_current_a, @max_pv_short_circuit_current_a, @max_charge_current, @nominal_battery_voltage, @notes)
  `);
...
export function seedPanelTypes(db: Database.Database): void {
  ...
  if (!existing || existing.count === 0) {
    const insert = db.prepare(`
      INSERT INTO panel_types (panel_type_id, model, wp, voc, vmp, isc, imp, length_mm, width_mm, notes, price)
      VALUES (@panel_type_id, @model, @wp, @voc, @vmp, @isc, @imp, @length_mm, @width_mm, @notes, @price)
    `);
