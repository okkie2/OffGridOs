...
- `conversion_devices`, `load_circuits`, and `loads`: the load-side model for downstream electrical demand
...
- `load_circuits` groups one or more loads behind one protected distribution point
